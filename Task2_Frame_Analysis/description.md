...
- car: 48 detections — dominant class across all frames
- bus: 15 detections — large vehicles consistently visible
- person: 4 detections — pedestrians near road edges
- truck: 1 detection — occasional heavy vehicle
...
### 3. COCO class limitations
COCO does not include domain-specific classes like emergency vehicles, lane markings, or road signs. Fine-tuning on datasets like BDD100K or nuScenes would improve detection performance in real-world driving scenarios.
